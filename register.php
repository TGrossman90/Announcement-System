	...
	<body>  
		<div id="main" class="shadow" style="text-align: center;">
							...
							if(mysqli_num_rows($checkuser) != 0 ) {
								...
								if(filter_var($username, FILTER_VALIDATE_EMAIL)) {
									...
									if(! in_array($domain, $allowed)) {
										$usernameError = "You must use your UMSL email!";
									} else {
										...
										if(!empty($_POST['optout']) && (($_POST['mobile_carrier'] == "none") || empty($_POST['mobile_number']))) {
											...
											if(empty($_POST['optout'])) {		
												...
												$sql = "INSERT INTO users (id, username, name, password, mobile, optstatus, verification) VALUES ('NULL', '$username', '$username', '$hash', '$mobile', '$optstatus', '$verificationHash')";
												...
												$message = '<html><body>';
												$message .= 'A new user has registered!<br />';
												$message .= '<br />Username: '.$username.'<br />';
												$message .= '<br /><br />This email is system generated. Please do not reply -- it will never be seen.';
												$message .= '</body></html>';												
												mail($globalAdmin, "A New User has Registered", $message, $headers);
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">  
				...
				<span class="error">* <br /> <?php echo $usernameError; ?></span>
				<br /><br />
				
				<label for="password">Password: </label> <input type="password" name="password">
				<span class="error">* <br /> <?php echo $passwordError; ?></span>
				<br /><br />
				
				<label for="passwordVerify">Re-enter Password: </label> <input type="password" name="passwordVerify">
				<span class="error">* <br /><?php echo $passwordVerifyError; ?></span>
				<br /><br /><br />
