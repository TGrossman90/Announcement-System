...
<html>  
	<head>  
		<title>UMSL Music Announcement System</title>
		...
		<div id="main" style="text-align: center;" class="shadow">
			...
			<?php
				...
				if($_SESSION['loggedin'] == 1) {
					...
					if($count > 0) {
						printf("<p>You have %u announcement(s) to read!</p>", $count);
						echo '<a href="announceInbox.php" class="button">Go to Inbox</a> <br />';
					}
					
					echo '<a href="calendar.php" class="button">View Calendar</a><br />';
					echo '<a href="userCP.php" class="button">User Control Panel</a> <br /> <br />';
					...
					echo '<br /><a href="logout.php" class="buttonForm">Logout</a>';		
					...
					// Verify the password is a match and login
						...
						if($verified[0] == "verified") {
							...
							// The password is wrong
								...
								echo '<a href="index.php" class="buttonForm">Go Back</a>&nbsp;<a href="recoverPassword.php" class="buttonForm">Forgot Password?</a>';
							}
						
						} else {
							echo '<p>You need to verify your account before you can login.</p>';
							echo '<form method="post" action="resendVerification.php">';
							echo '<fieldset>';
							echo '<input type="hidden" name="username" value="'.$username.'">';
							echo '<p>Lost your verification email/text?</p> <input type="submit" name="login" value="Resend Verification" class="buttonForm" /><br />';
