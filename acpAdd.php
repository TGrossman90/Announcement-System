	...
	<body>  
		...
		<form method="post" action="authStudents.php" name="authUsers">
			<fieldset>
				...
				<textarea placeholder="sso1@mail.umsl.edu, sso2@mail.umsl.edu, sso3@mail.umsl.edu, sso4@mail.umsl.edu, sso5@mail.umsl.edu" id="students" name="students" cols="40" rows="5"></textarea><br />
		...
		<form method="post" action="authFacAdmin.php" name="authFacAdmin">
			<fieldset>
				...
				<textarea placeholder="user1@umsl.edu, user2@umsl.edu, user3@umsl.edu, user4@umsl.edu, user5@umsl.edu" id="facultyAdmin" name="facultyAdmin" cols="40" rows="5"></textarea><br />
