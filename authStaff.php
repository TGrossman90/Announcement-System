...
<html>  
	<head>  
		<title>UMSL Music: Adding Staff</title>
							...
							if($level == "faculty") {
								if(!empty($_POST['groups'])) {
										...
										if(is_null($isParent[0])) {
											...
											foreach($grps as $grp) {
												...
												if(mysqli_num_rows($result) == 0) {
													...
													$result = mysqliQuery($sql);
													echo '<p>' . $user . ' now manages ' . $grp . '</p>';
												} else {
													echo '<p>' . $user . ' already manages ' . $grp . '! </p>';
												}
											}
											...
											if(mysqli_num_rows($result) == 0) {
												...
												$result = mysqliQuery($sql);
												echo '<p>' . $user . ' now manages ' . $group . '</p>';
											} else {
												echo '<p>' . $user . ' already manages ' . $group . '! </p>';
											}
									...
									if(mysqli_num_rows($result) == 0) {
										...
										echo '<p>' . $user . ' is already a faculty account! </p>';
									}
